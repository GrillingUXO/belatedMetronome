...
def adjust_audio_segments(note_mappings, audio_file, video_file, output_folder, log_file="adjustment_log.txt"):
    ...
    with open(log_file, "w") as log:
        ...
        def generate_transition_waveform(audio1, audio2, sr, duration):
            ...
            """
            # Find zero-crossing near the end of audio1 and the start of audio2
            ...
            # Perform linear interpolation to smooth transition
            ...
            try:
                ...
                if start_time > last_end_time:
                    ...
                    if gap_audio.shape[1] == 0:
                        ...
                        left_audio = segments[-1]["audio"] if segments else np.zeros((2, 1))
        ...
        try:
            ...
            final_audio = np.hstack([s["audio"] for s in segments])
