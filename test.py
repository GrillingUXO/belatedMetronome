...
def adjust_audio_segments(note_mappings, audio_file, video_file, output_folder, log_file="adjustment_log.txt"):
    ...
    with open(log_file, "w") as log:
        ...
        try:
            ...
            y = y.astype('float32')  # Force conversion to float64
            ...
            try:
                ...
                if start_time > last_end_time:
                    ...
                    if gap_duration < 0.01:  # Gap is less than 10ms
                        ...
                        combined_audio = y[:, start_idx:end_idx].astype('float32')  # Force conversion to float64
                        ...
                        ]).astype('float32')  # Force conversion to float64
                ...
                segment_audio = y[:, start_idx:end_idx].astype('float32')  # Force conversion to float64
                ...
                if len(segments_and_gaps) > 0:
                    ...
                    crossfade_audio = np.zeros((2, crossfade_samples)).astype('float32')  # Force conversion to float64
        ...
        try:
            ...
            final_video = concatenate_videoclips([seg["video"] for seg in segments_and_gaps], method="compose")
